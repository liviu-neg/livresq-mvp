...
// SVG Icons (same as BlockToolbar)
const TrashIcon = () => (
...
interface CellToolbarProps {
  cellContainerRef: React.RefObject<HTMLElement>;
  onDelete: () => void;
  onDuplicate: () => void;
  onDragStart: (e: React.MouseEvent) => void;
  onEdit?: () => void; // Open properties panel for cell
}
    ...
    >
      {onEdit && (
        <>
          ...
          <div className="cell-toolbar-divider"></div>
        </>
      )}
      <button
        type="button"
      ...
      <button
        type="button"
        className="cell-toolbar-button cell-toolbar-drag"
        onMouseDown={(e) => {
          e.stopPropagation();
          onDragStart(e);
        }}
      ...
      <button
        type="button"
        className="cell-toolbar-button cell-toolbar-label-button"
        aria-label="Cell type"
      >
        <span className="cell-toolbar-label-text">Cell</span>
      </button>
    </div>
  );
